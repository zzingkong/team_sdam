			...
			<div class="collapse navbar-collapse" >
				<div class="navbar-nav">
					<div class="nav-item dropdown">
						<a class="nav-item nav-link" href="${root }user/adminpage" aria-current="page" style="padding:0 0 10px 0;"><span class="text-primary me-2">#</span> 회원관리</a> <!-- aria-current 현재페이지 -->
						<a class="nav-item nav-link" href="#" style="padding:10px 0;"> 예약승인관리</a>
					</div>
				</div>
			</div>
		</nav>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="#">수정</a></td>
						<td><a href="${root }user/admindelete?user_idx=${adminUserList.user_idx}">탈퇴</a></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
