      ...
      <div class="container">
         <div class="row g-5 mb-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="wrap2">
               ...
               <div class="col-lg-3 col-md-6 label" style="float:right; margin-right:40px;">                           
            ...
            <div class="card" style="width: 18rem; margin-right:35px;">
              <img src="/image/혜진 테라피스트.jpg" class="card-img-top"  style="height:30rem;" alt="...">
                 <div class="card-body">
                   <h5 class="card-title">김혜진 테라피스트</h5>
                   <p class="card-text">주요지역 : 경북 / 경남 <br>
                  경력: 6년<br></p>

             <a href="#" class="btn btn-primary" style="width:100px;">더보기</a><p><img src="/image/heart.png">2,500 </p>

               </div>
            </div>
            
            <div class="card" style="width: 18rem; margin-right:40px;">
              <img src="image/therapist.PNG" class="card-img-top" style="height:30rem;" alt="...">
                 <div class="card-body">
                   <h5 class="card-title">임유리나 테라피스트</h5>
                   <p class="card-text">주요지역 : 세종 / 대전 <br>
                  경력: 15년<br></p>

                  <a href="#" class="btn btn-primary" style="width:100px;">더보기</a><p><img src="/image/heart.png">5,000</p>
            ...
            <div class="card" style="width: 18rem; margin-right:40px;">
              <img src="image/therapist.PNG" class="card-img-top" style="height:30rem;" alt="...">
                 <div class="card-body">
                  ...
                  경력: 6년<br></p>
                  <p><a href="#" class="btn btn-primary" style="width:100px;">더보기</a><img src="/image/f_heart3.JPG">  5,500 </p>
               </div>
            </div>
            ...
            <div class="card" style="width: 18rem;">
              <img src="image/therapist.PNG" class="card-img-top"  style="height:30rem;" alt="...">
                 <div class="card-body">
                  ...
                  경력: 6년<br></p>
                  <p><a href="#" class="btn btn-primary" style="width:100px;">더보기</a><img src="/image/f_heart3.JPG"> 6,500 </p>
               </div>
            </div>
         </div>
      </div>      
